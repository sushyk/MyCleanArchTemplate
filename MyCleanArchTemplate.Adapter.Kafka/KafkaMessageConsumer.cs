...
namespace MyCleanArchTemplate.Adapter.Kafka
{
    internal class KafkaMessageConsumer : BackgroundService
    {
        ...
        public KafkaMessageConsumer(ILogger<KafkaMessageConsumer> logger, IOptions<ConsumerConfig> consumerConfigOptions)
        {
            _logger = logger ?? throw new ArgumentNullException(nameof(logger));
            _consumer = new ConsumerBuilder<string, string>(consumerConfigOptions.Value).Build();
        }
